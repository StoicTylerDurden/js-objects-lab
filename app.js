...
*/
const morePokemonPlease = pokemon.slice(1, 4);
game.party.push(...morePokemonPlease);
...
if (starterIndex !== -1) {
    ...
    game.party[starterIndex] = pokemon.find(p => p.number === evolvedPokemonMap[starterNumber]);
}
